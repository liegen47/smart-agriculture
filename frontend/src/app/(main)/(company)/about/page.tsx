    ...
    <div className="my-24 relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl">
        ...
        <h1 className="mt-6 text-4xl sm:text-5xl md:text-6xl font-black leading-[1.1] tracking-tight">
          Welcome to <span className="text-primary">NatureSense</span>
        </h1>
        <p className="mt-6 text-[17px] md:text-lg text-gray-500">
        ...
        <div className="mt-12 flex flex-col md:flex-row items-center justify-center gap-4">
          <Button
            size="lg"
            className="rounded-full text-base bg-primary hover:bg-green-700"
          >
          ...
          <Button
            variant="outline"
            size="lg"
            className="rounded-full text-base shadow-none border-primary text-primary hover:bg-green-50"
          >
      ...
      <div className="relative z-10 mt-24 max-w-6xl w-full px-6">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <div className="h-12 w-12 flex items-center justify-center bg-green-50 text-primary rounded-full">
      ...
      <div className="relative z-10 mt-24 max-w-6xl w-full px-6">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="mt-2 text-gray-500">Lead Data Scientist</p>
          </div>
